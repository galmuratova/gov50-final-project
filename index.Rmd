...
### Introduction 
This study compares the voting patterns to the residential mobility of the individual to see if there’s a correlation between voting Democratic and moving to a different region than where the individual resided when they were 16. The following is the question of inquiry for this study: is residential mobility associated with a Democratic voting pattern?
...
This regression table estimates that when individuals do not move, when their race is  white, and when they believe that the national spending on education is about right, the proportion of Democratic votes is .33. Holding other predictors constant, when an individual believes that the national spending on education is too little, the proportion of Democrat votes increased by about .2 on average. Holding other predictors constant, when an individual believes that the national spending on education is too much, the proportion of Democrat votes decreases by about .31 on average. Holding other predictors constant, when the individual is white, the proportion of Democrat votes decreases by about .32 on average.  Holding other predictors constant, when the indivdual had not changed residential state since they were 16, Democrat voting proportion increases by about .06 on average. It's important to note that the t value is .03 which is greater than .01 so there is some chance that the extremities in this data are due to chance.

Because the multiple regression model, Model 2, takes into account multiple explanatory variables, it account for some confounding variables. For example, perhaps individuals of a specific race move move often and they vote Democrat because of their race rather than their mobility. Thus, because Model 2 takes into account confounding variables and is statistically significant, it represents a causal relationship more than Model 1. 
